...
<body bgcolor="#BBDAF2" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-4" data-genuitec-path="/xscj/WebRoot/main.jsp">
    <table bgcolor="#BBDAF2" width="200" height="85" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-4" data-genuitec-path="/xscj/WebRoot/main.jsp">
        <tr>
            <td align="center">
